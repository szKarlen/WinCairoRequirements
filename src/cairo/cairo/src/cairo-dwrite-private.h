...
public:
    ...
    static IDWriteRenderingParams *RenderingParams(TextRenderingState mode)
    {
	...
	IDWriteRenderingParams *params;
        if (mode == TEXT_RENDERING_NO_CLEARTYPE) {
            params = mDefaultRenderingParams;
        } else if (mode == TEXT_RENDERING_GDI_CLASSIC && mRenderingMode < 0) {
